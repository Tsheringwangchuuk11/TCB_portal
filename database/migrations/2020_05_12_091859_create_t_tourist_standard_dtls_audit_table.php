...
class CreateTTouristStandardDtlsAuditTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('t_tourist_standard_dtls_audit', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('t_tourist_standard_dtls_audit');
    }
}
