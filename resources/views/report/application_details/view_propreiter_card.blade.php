...
@section('content')
<form action="{{ url('verification/proprieter-card') }}" method="POST" files="true" id="form_data" enctype="multipart/form-data">
    @csrf
                        ...
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="validity_date" data-target-input="nearest">
                                    <input type="text" name="validity_date" class="form-control datetimepicker-input" data-target="#validity_date" value="{{ $applicantInfo->validity_date }}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <select  name="location" class="form-control select2bs4" id="village_id" style="width: 100%;" disabled>
