...
@section('page-title','Name/Ownership Change/Cancellation')
@section('content')
<form action="{{ url('verification/name-ownership-cancellation-for-tented-accom') }}" method="POST" files="true" id="form_data" enctype="multipart/form-data">
    @csrf
...
<div class="card">
    <div class="card-header">
        <h4 class="card-title">Tented Accommodation Location</h4>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-md-5">
