                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <select class="form-control select2bs4" name="star_category_id" id="star_category_id" style="width: 100%;" disabled>
                                <option value="">- Select -</option>
                    ...
                    <div class="row">
                        <div class="form-group col-md-5">
                            ...
                            <input type="date" class="form-control" name="license_date" value="{{ $applicantInfo->license_date }}" disabled>
                            <input type="hidden" class="form-control" name="dispatch_no" value="{{ $applicantInfo->dispatch_no }}" disabled>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 offset-md-2">
                            ...
                            <input type="number" class="form-control" name="number" value="{{ $applicantInfo->number }}" disabled>
                        </div>
                    </div>
                </div>
            </div>
