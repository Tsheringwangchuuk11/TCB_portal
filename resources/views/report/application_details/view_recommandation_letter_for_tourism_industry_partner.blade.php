            ...
            <div class="row">
                ...
                <div class="col-md-5 offset-md-2">
                    <div class="form-group">
                      ...
                      <select class="form-control  select2bs4" name="application_type_id" id="letter_sample" disabled>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="validity_date" data-target-input="nearest">
                        <input type="text" name="validity_date" class="form-control" value="{{ $applicantInfo->validity_date }}" disabled>
                    </div>
                    </div>
                </div> 
                <div class="col-md-5 offset-md-2">
