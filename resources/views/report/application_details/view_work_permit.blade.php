        ...
        <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="application_no" value="{{ $applicantInfo->application_no }}" autocomplete="off" disabled>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="license_no" value="{{ $applicantInfo->license_no }}" autocomplete="off" disabled>
                        </div>
                        </div>
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                                <label for="" >Comapany Name<span class="text-danger"> *</span></label>
                                <input type="text" class="form-control" name="company_name" value="{{ old('company_name',$applicantInfo->company_title_name) }}" autocomplete="off" disabled>
                            </div>
                    </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="total_worker" value="{{ $applicantInfo->number }}" autocomplete="off" disabled>
                                </div>
                            </div>
                            <div class="col-md-5 offset-md-2">
                                <div class="form-group">
                                    <label for="" >Nationality<span class="text-danger"> *</span></label>
                                    <select  name="country_id" class="form-control select2bs4" style="width: 100%;" disabled>
                                        <option value=""> -Select-</option>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="from_date" data-target-input="nearest">
                                    <input type="text" name="from_date" class="form-control datetimepicker-input" data-target="#from_date"  value="{{ $applicantInfo->from_date }}" disabled>
                                </div>
                            </div>
                            </div>
                            <div class="col-md-5 offset-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="to_date" data-target-input="nearest">
                                        <input type="text" name="to_date" class="form-control datetimepicker-input" data-target="#to_date"  value="{{ $applicantInfo->to_date }}" disabled>
                                    </div>                                
                                </div>
                        </div>
                        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                        <input type="text" class="form-control" name="passport_no[]" value="{{ $workerdtl->passport_no }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="text" class="form-control" name="name[]" value="{{ old('name',$workerdtl->name) }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                        <input type="date" name="start_date[]" class="form-control" value="{{ $workerdtl->start_date }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="date" name="end_date[]" class="form-control" value="{{ old('end_date',$workerdtl->end_date) }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <select  name="nationality[]" class="form-control" style="width: 100%;" disabled>
                                <option value=""> -Select-</option>
                                @foreach ($countries as $country)
