            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="agent_cid_no" value="{{ $applicantInfo->cid_no }}" disabled>
                    </div>
                </div>
                <div class="col-md-5 offset-md-2">
                    <div class="form-group">
                        <label for="">Designation <span class="text-danger"> *</span></label>
                        <input type="text" class="form-control" name="designation" value="{{ $applicantInfo->designation }}" disabled>
                    </div>
                </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="website" value="{{ $applicantInfo->webpage_url }}" disabled>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="agency_address" class="form-control" value="{{ $applicantInfo->address }}" disabled>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="">City <span class="text-danger"> *<span></label>
                                    <input type="text" class="form-control" name="city" value="{{ $applicantInfo->city }}" disabled>
                                </div>
                            </div>
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker" name="to_date" value="{{ $applicantInfo->to_date }}" disabled>
                            </div>
                        </div>
                    </div>
        </div>
