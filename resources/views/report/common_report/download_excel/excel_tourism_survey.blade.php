    @if ($report_name_id==1)
        <table>
            <thead>
                <tr>
                    <th colspan="4" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                </tr>
                <tr>
                    <th>Purpose</th>
                    <th>Air</th>
    ...
    @elseif($report_name_id==2)
        <table>
            <thead>
                <tr>
                    <th colspan="13" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                </tr>
                <tr>
                    <th>Purpose</th>
                    <th>Jan</th>
    ...
    @endphp
        <table>
            <thead>
                <tr>
                    <th colspan="5" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                </tr>
                <tr>
                    <th>Purpose</th>
                    <th>Visitor</th>
        ...
        @elseif($report_name_id==4)
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="8" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                    </tr>
                    <tr>
                        <th>Purpose</th>
                        <th>1-2 Nights</th>
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="3" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                    </tr>
                    <tr>
                        <th>Country</th>
                        <th>Mean</th>
            ...
            <table>
                <thead>
                    <tr>
                        <th colspan="16" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                    </tr>
                    <tr>
        ...
        @elseif($report_name_id==10 || $report_name_id==19)
            <table>
                <thead>
                    <tr>
                        <th colspan="10" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                    </tr>
                    <tr>
                        <th>Dzongkhag </th>
        ...
        @endphp
            <table class="main" style="table-layout:fixed;">
                <thead>
                    <tr>
                        <th colspan="9" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                    </tr>
                    <tr>
                        <th>Destination </th>
                        <th>Holiday/Leisure/Recreation</th>
        ...
        @endphp
            <table>
                <thead>
                    <tr>
                        <th colspan="22" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                    </tr>
                    <tr>
            ...
            @elseif($report_name_id==24)
                ...
                <table>
                    <thead>
                        <tr>
                            <th colspan="6" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                        </tr>
                        <tr>
            ...
            @elseif($report_name_id==26)
                <table>
                    <thead>
                        <tr>
                            <th colspan="15" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                        </tr>
                        <tr>
                            <th>Purpose</th>
                            <th>Tour packages</th>
            ...
            <table>
                <thead>
                        <tr>
                            <th colspan="11" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                        </tr>
                        <tr>
                            <th>Destination </th>
                            <th>Holiday/Leisure/Recreation</th>
            ...
            <table>
                <thead>
                        <tr>
                            <th colspan="12" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                        </tr>
                        <tr>
                            <th>Purpose</th>
                            <th>Long distance transportation</th>
            ...
            <table>
                <thead>
                        <tr>
                            <th colspan="14" style="background-color:#009e9e;">{{$reportname->report_name}}</th>
                        </tr>
                        <tr>
                            <th>Destination</th>
