                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact_no" class="form-control numeric-only required" value="{{ old('contact_no') }}" autocomplete="off">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-md-5 offset-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tentative_cons" class="form-control required" value="{{ old('tentative_cons') }}" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control required" name="tentative_com" value="{{ old('tentative_com') }}" autocomplete="off" >
                        ...
                        <div class="col-md-5 offset-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker required" name="drawing_date" value="{{ old('drawing_date') }}" id="drawing_date" autocomplete="off" >
                    ...
                    <div class="row">         
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control email required" value="{{ old('email') }}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
