...
@section('page-title','Home Stay Name Change')
@section('content')
<div class="card">
          ...
          <div class="row">
            ...
            <div class="col-md-5 offset-md-2">
              <div class="form-group ">
                ...
                <input type="text" class="form-control numeric-only" name="cid_no">
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-5">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="contact_no numeric-only">
              </div>
            </div>
            <div class="col-md-5 offset-md-2">
              <div class="form-group">
