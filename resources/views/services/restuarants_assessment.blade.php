...
<script>
  $(function () {
    ...
    success: function (data) {
      count++;
      $('#files').append('<div class ="row" ><div class = "col-lg-4"><div class = "pull-center"><a href="#" onClick="deletefile(this.id)" id="deleteId'+count+'" styleClass="fileUUID" class="delete-line"  data-file_id="'+data[0].fileUUID+'" data-file_path ="'+data[0].filePath+'"><span class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete<span></a></div></div><br></div>');     
      count++; 
    }
  });
  });
