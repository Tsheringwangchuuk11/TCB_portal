            ...
            <div class="col-md-5 offset-md-2">
                <div class="form-group">
                    ...
                    <div class="input-group date" id="eventstartDate" data-target-input="nearest">
                        <input type="text" name="start_date" class="form-control datetimepicker-input" data-target="#eventstartDate" value="{{$data->start_date}}">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <div class="input-group date" id="eventendDate" data-target-input="nearest">
                        <input type="text" name="end_date" class="form-control datetimepicker-input" data-target="#eventendDate" value="{{$data->end_date}}" >
