                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if ((int)$privileges->edit== 1)
                                    <a href="{{ url('system/resend-verification-codes/' . $user->id . '/edit') }}" class="btn bg-outline-purple btn-xs btn-flat margin-r-5" title="Resend Code"><i class="fas fa-edit"></i></a>
                                @endif
                            </td>
                        </tr>
                    @empty
