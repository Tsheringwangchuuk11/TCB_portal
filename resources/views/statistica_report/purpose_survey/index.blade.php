             ...
             <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="report_category_id" class="form-control" id="report_category_id" onchange="changeReportCategory(this.value)">
                        </select>
                    </div>
                </div>  
                <div class="col-md-3" style="display:none" id="visitor_type_display">
                    <div class="form-group">
                        <label>Visitor Types</label>
                        <select name="visitor_type_id" id="visitor_type_id" class="form-control" onchange="changeVistorTypes()">
...
<script>
     $(document).ready(function(){
        ...
        function changeReportCategory(report_category_id){
            if(report_category_id==1){
                $("#visitor_type_display").show();	
                $('#visitor_type_id').trigger("change");
            }  
            else if(report_category_id==2){
                $("#visitor_type_display").hide();	
                generateAjaxReports();
            }
                ...
                $("#visitor_type_id option:selected").prop("selected", false)
                $("#visitor_type_display").hide();	
                generateAjaxReports();
            }
        }
        
        function changeVistorTypes(){
            generateAjaxReports();
        }
         ...
         function generateAjaxReports() {
            ...
            $('#dataResult').load('{{url("statistical/show-purpose-survey/")}}/'+ report_type_id+'/'+report_category_id+'/'+visitor_type_id);
         } 
        ...
        var report_category_id= $('#report_category_id').val();
        var visitor_type_id= $('#visitor_type_id').val();
        var dataURL = '{{ url("statistical/create-purpose-survey/") }}/'+ report_type_id+'/'+report_category_id+'/'+visitor_type_id;
