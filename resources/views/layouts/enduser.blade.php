...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  {{--     <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" rel="stylesheet"> --}}        <!-- Select2 -->
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        <div class="wrapper">
            <div id="app">
                @include('layouts.include.enduser_header')
                @include('layouts.include.enduser_sidebar')
